...
public class SomMissaoCompleta {

	public void main(String[] args) {

		// STRING COM O CAMINHO DO ARQUIVO A SER TOCADO
		String path = "res/sons/missao/completa/success.mp3";

		// INSTANCIAÇÃO DE UM OBJETO FILE COMO ARQUIVO MP3
		File mp3File = new File(path);

		// INSTANCIAÇÃO DO OBJETO MP3 SOM DESPARO
		MP3SomMissaoCompleta missaoCompleta = new MP3SomMissaoCompleta();
		missaoCompleta.tocarSom(mp3File);

		// CHAM O METODO QUE TOCA O SOM
		missaoCompleta.start();
	}
	 ...
	 * ====================================================================
	 */
	private static class MP3SomMissaoCompleta extends Thread {
		...
		public void run() {
			try {
				...
				this.player.play();
				// System.out.println("Terminado Missão Completa!");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null,
						"Problema ao tocar Misão Completa" + mp3);
				e.printStackTrace();
			}
		}
	}
