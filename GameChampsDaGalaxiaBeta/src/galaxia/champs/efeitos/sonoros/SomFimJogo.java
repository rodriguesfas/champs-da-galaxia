...
public class SomFimJogo {
	...
	public void main(String[] args) {
		...
		MP3SomMissaoFalida mf = new MP3SomMissaoFalida();
		mf.tocarSom(mp3File);
	 ...
	 * ====================================================================
	 */
	private static class MP3SomMissaoFalida extends Thread {
		...
		public void run() {
			try {
				...
				// System.out.println("INICIO FIM JOGO!");
				this.player.play();
				// System.out.println("TEMINOU FIM JOGO!");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null,
						"Problema ao tocar Fim Jogo" + mp3);
				e.printStackTrace();
			}
		}
	}
