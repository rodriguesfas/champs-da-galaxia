...
public class SomAddVida {
	...
	/**
	 * ====================================================================
	 * =======================================CLASS INTERNA MP3 SOM COLISÃO
	 * ====================================================================
	 */
	private static class MP3SomAddVida extends Thread {
		 ...
		 * @param mp3
		 */
		public void tocarAddVida(File mp3) {
			this.mp3 = mp3;
		}
		...
		public void run() {
			try {
				...
				// System.out.println("AddVida!");
				this.player.play();
				// System.out.println("Terminado AddVida!");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null, "Problema ao tocar AddVida"
						+ mp3);
				e.printStackTrace();
			}
		}
