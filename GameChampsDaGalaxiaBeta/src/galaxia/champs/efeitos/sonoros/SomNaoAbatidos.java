...
public class SomNaoAbatidos {
	 ...
	 * ====================================================================
	 */
	private static class MP3SomNaoAbatidos extends Thread {
		...
		public void run() {
			try {
				...
				// System.out.println("SomNaoAbatidos!");
				this.player.play();
				// System.out.println("TERMINOU SomNaoAbatidos!");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null,
						"Problema ao tocar Som Não Abatidos" + mp3);
				e.printStackTrace();
			}
		}
	}
