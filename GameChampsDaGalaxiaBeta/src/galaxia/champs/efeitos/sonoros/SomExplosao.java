...
public class SomExplosao {
	public void main(String[] args) {
		...
		MP3SomExplosao explosao = new MP3SomExplosao();
		explosao.tocarExposao(mp3File);
	...
	/**
	 * ====================================================================
	 * =======================================CLASS INTERNA MP3 SOM EXPLOSÃO
	 * ====================================================================
	 */
	private static class MP3SomExplosao extends Thread {
		 ...
		 * @param mp3
		 */
		public void tocarExposao(File mp3) {
			this.mp3 = mp3;
		}
		...
		public void run() {
			try {
				...
				// JOptionPane.showMessageDialog(null, "Explosão");

				this.player.play();
				// JOptionPane.showMessageDialog(null, "Terminado Explosão");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null,
						"Problema ao tocar Explosao" + mp3);
				e.printStackTrace();
			}
		}
	}
