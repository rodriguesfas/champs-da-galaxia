...
public class SomColisao {
	 ...
	 * ====================================================================
	 */
	private static class MP3SomColisao extends Thread {
		 ...
		 * @param mp3
		 */
		public void tocarColisao(File mp3) {
			this.mp3 = mp3;
		}
		...
		public void run() {
			try {
				...
				this.player.play();
				// System.out.println("Terminado Colisaõ!");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null, "Problema ao tocar Colisão"
						+ mp3);
				e.printStackTrace();
			}
		}
