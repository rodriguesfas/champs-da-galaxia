...
public class SomZeroVida {
	 ...
	 * ====================================================================
	 */
	private static class MP3SomZeroVida extends Thread {
		 ...
		 * @param mp3
		 */
		public void tocarSomZeroVida(File mp3) {
			this.mp3 = mp3;
		}
		...
		public void run() {
			try {
				...
				// /System.out.println("ZERO VIDA!");
				this.player.play();
				// System.out.println("Terminado ZERO VIDA!");
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null,
						"Problema ao tocar Zero Vida" + mp3);
				e.printStackTrace();
			}
		}
	}
